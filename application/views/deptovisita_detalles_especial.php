        ...
        <div class="row">
            ...
            <div class="panel panel-primary">
                ...
                <div class="panel-body">
                    ...
                    <?php echo form_open('departamento/buscar_departamentos'); ?>
                    <div class="col-md-4">
                    ...
                    <div class="col-md-2">
                        <br>
						<input type='checkbox' name='condiciones' value="especial"> Búsqueda Especial
            ...
            <?php  foreach ($lista_departamentos as $item) { //item es el nombre de la variable para poder acceder a los datos "lista_deptos" que vienen del controlador "tipo_departamento"
                ...
                <div class="col-md-4 text-center">
                    <div class="panel panel-warning">
                        ...
                        <div class="panel-footer">
                            <a class="btn btn-lg btn-block btn-warning" href='<?php echo site_url()?>/login/index'>RESERVE AHORA!</a>
                        </div>
                    </div>
                </div>
            <?php $i++;} ?>
